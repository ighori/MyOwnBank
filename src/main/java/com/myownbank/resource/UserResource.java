package com.myownbank.resource;
...
//    @RequestMapping(value = "/user/credit/transaction", method = RequestMethod.GET)
//    public List<CreditTransaction> getCreditTransactionList(@RequestParam("username") String username) {
//        return transactionService.findCreditTransactionList(username);
//    }
