...
public class CcApplicationController {
    ...
    @RequestMapping(value = "/ccApplication", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/ccApplication/save", method = RequestMethod.POST)
...
//        loanapplication.setDate(d1);
        ...
        return "redirect:/appointment/ccApplication";
    }

    @RequestMapping(value = "/ccApplication/edit", method = RequestMethod.GET)
    ...
    @RequestMapping(value = "/ccApplication/delete", method = RequestMethod.GET)
    @Transactional
